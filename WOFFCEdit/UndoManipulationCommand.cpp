...
UndoManipulationCommand::UndoManipulationCommand()
{
	type = Commands::CommandType::UndoManipulation;
}

void UndoManipulationCommand::setup(DisplayObject* object)
{
...
void UndoManipulationCommand::performAction(std::vector<DisplayObject>* displayList)
{
...
DisplayObject* UndoManipulationCommand::getStoredObject()
{
	return storedObject;
}

std::vector<DisplayObject*> UndoManipulationCommand::getStoredObjects()
{
	return storedObjects;
}

void UndoManipulationCommand::setup(std::vector<DisplayObject*> objects)
{
